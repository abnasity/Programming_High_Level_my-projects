...
influencer = Student(name="Enock", age=23, id=40498987, is_admin=False, is_logged_in=True) #Directed to login page
print(f"{influencer.name} aged {influencer.age} has an id number of {influencer.id} is directed to {influencer.influencer_status()}")

influencer = Student(name="Enock", age=23, id=40498987, is_admin=False, is_logged_in=False) #Directed to newsfeed
print(f"{influencer.name} aged {influencer.age} has an id number of {influencer.id} is directed to {influencer.influencer_status()}")
